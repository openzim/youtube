...
5242880>G&&x("TOTAL_MEMORY should be larger than TOTAL_STACK, was "+G+"! (TOTAL_STACK=5242880)");a.buffer?buffer=a.buffer:"object"===typeof WebAssembly&&"function"===typeof WebAssembly.Memory?(y=new WebAssembly.Memory({initial:G/65536}),buffer=y.buffer):buffer=new ArrayBuffer(G);F();E[7544]=5273088;function H(b){for(;0<b.length;){var c=b.shift();if("function"==typeof c)c();else{var d=c.w;"number"===typeof d?void 0===c.v?a.dynCall_v(d):a.dynCall_vi(d,c.v):d(void 0===c.v?null:c.v)}}}
var I=[],ba=[],ca=[],K=[],L=!1;function da(){var b=a.preRun.shift();I.unshift(b)}var M=0,N=null,O=null;a.preloadedImages={};a.preloadedAudios={};function P(){var b=Q;return String.prototype.startsWith?b.startsWith("data:application/octet-stream;base64,"):0===b.indexOf("data:application/octet-stream;base64,")}var Q="ogv-decoder-audio-opus-wasm.wasm";if(!P()){var R=Q;Q=a.locateFile?a.locateFile(R,r):r+R;Q=zim_fix_wasm_target(Q);}
...
c)}catch(A){return x("Module.instantiateWasm callback failed with error: "+A),!1}(function(){return a.wasmBinary||"function"!==typeof WebAssembly.instantiateStreaming||P()||"function"!==typeof fetch?e(d):WebAssembly.instantiateStreaming(fetch(Q,{credentials:"same-origin"}),q).then(d,function(b){x("wasm streaming compile failed: "+b);x("falling back to ArrayBuffer instantiation");e(d)})})();return{}}
a.asm=function(b,c){c.memory=y;c.table=new WebAssembly.Table({initial:2,maximum:2,element:"anyfunc"});c.__memory_base=1024;c.__table_base=0;return fa(c)};function ha(){return C.length}function T(){T.u||(T.u=[]);T.u.push(ia());return T.u.length-1}function ja(b){b=B(b);var c=buffer.byteLength;try{return-1!==y.grow((b-c)/65536)?(buffer=y.buffer,!0):!1}catch(d){return!1}}
var la=a.asm({},{k:v,d:function(b){a.___errno_location&&(E[a.___errno_location()>>2]=b);return b},j:ha,i:function(b,c,d){D.set(D.subarray(c,c+d),b)},h:function(b){if(2147418112<b)return!1;for(var c=Math.max(ha(),16777216);c<b;)536870912>=c?c=B(2*c):c=Math.min(B((3*c+2147483648)/4),2147418112);if(!ja(c))return!1;F();return!0},b:function(b){var c=T.u[b];T.u.splice(b,1);ka(c)},c:T,g:function(b,c,d){var e=a.HEAPU32,q=a.HEAPF32,A=[];if(0!==b)for(var f,J=0;J<c;J++)f=e[b/4+J],q.buffer.slice?(f=q.buffer.slice(f,
f+4*d),f=new Float32Array(f)):(f=q.subarray(f/4,f/4+d),f=new Float32Array(f)),A.push(f);a.audioBuffer=A},f:function(b,c){a.audioFormat={channels:b,rate:c};a.loadedMetadata=!0},e:function(){v("OOM")},a:30176},buffer);a.asm=la;a._free=function(){return a.asm.l.apply(null,arguments)};a._malloc=function(){return a.asm.m.apply(null,arguments)};a._ogv_audio_decoder_destroy=function(){return a.asm.n.apply(null,arguments)};a._ogv_audio_decoder_init=function(){return a.asm.o.apply(null,arguments)};
a._ogv_audio_decoder_process_audio=function(){return a.asm.p.apply(null,arguments)};a._ogv_audio_decoder_process_header=function(){return a.asm.q.apply(null,arguments)};var ka=a.stackRestore=function(){return a.asm.r.apply(null,arguments)},ia=a.stackSave=function(){return a.asm.s.apply(null,arguments)};a.asm=la;a.then=function(b){if(a.calledRun)b(a);else{var c=a.onRuntimeInitialized;a.onRuntimeInitialized=function(){c&&c();b(a)}}return a};
function U(b){this.name="ExitStatus";this.message="Program terminated with exit("+b+")";this.status=b}U.prototype=Error();U.prototype.constructor=U;O=function ma(){a.calledRun||V();a.calledRun||(O=ma)};
function V(){function b(){if(!a.calledRun&&(a.calledRun=!0,!z)){L||(L=!0,H(ba));H(ca);if(a.onRuntimeInitialized)a.onRuntimeInitialized();if(a.postRun)for("function"==typeof a.postRun&&(a.postRun=[a.postRun]);a.postRun.length;){var b=a.postRun.shift();K.unshift(b)}H(K)}}if(!(0<M)){if(a.preRun)for("function"==typeof a.preRun&&(a.preRun=[a.preRun]);a.preRun.length;)da();H(I);0<M||a.calledRun||(a.setStatus?(a.setStatus("Running..."),setTimeout(function(){setTimeout(function(){a.setStatus("")},1);b()},
1)):b())}}a.run=V;function v(b){if(a.onAbort)a.onAbort(b);void 0!==b?(w(b),x(b),b=JSON.stringify(b)):b="";z=!0;throw"abort("+b+"). Build with -s ASSERTIONS=1 for more info.";}a.abort=v;if(a.preInit)for("function"==typeof a.preInit&&(a.preInit=[a.preInit]);0<a.preInit.length;)a.preInit.pop()();a.noExitRuntime=!0;V();var W,X;function na(b){if(W&&X>=b)return W;W&&a._free(W);X=b;return W=a._malloc(X)}var Y;Y="undefined"===typeof performance||"undefined"===typeof performance.now?Date.now:performance.now.bind(performance);
